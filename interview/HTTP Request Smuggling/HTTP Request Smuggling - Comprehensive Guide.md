...
This module is interview-focused depth on **CL.TE/TE.CL parser desync between edge and origin tiers**. It is written for AppSec/Product Security interviews where you are expected to explain both attacker mechanics and practical defensive engineering decisions.
...
- Explain the mechanism and trust boundaries for `http-request-smuggling` clearly in 2-3 minutes.
