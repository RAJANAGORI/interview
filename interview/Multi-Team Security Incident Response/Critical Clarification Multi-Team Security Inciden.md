...
**Key Point:** Incident response is a team sport - clear roles and coordination are essential.

---

### **Misconception 2: "All teams need all information immediately during incidents"**
...
**Key Point:** Share relevant information with appropriate teams - avoid information overload.

---

### **Misconception 3: "Incident response coordination can be figured out during the incident"**
...
**Key Point:** You can't coordinate effectively under pressure without prior preparation and practice.

---

### **Misconception 4: "One person should make all decisions during incidents"**
...
**Key Point:** Clear authority and escalation paths enable effective decision-making.

---

### **Misconception 5: "Communication should wait until all facts are known"**
...
**Key Point:** Regular, transparent communication builds trust and reduces uncertainty.

---

## **✅ Key Takeaways**

1. **Team Effort**: Incident response requires coordination across multiple teams
2. **Need-to-Know**: Share information appropriately, avoid information overload
3. **Prepare and Practice**: Define roles and procedures before incidents
4. **Structured Decisions**: Clear authority and escalation paths for decision-making
5. **Regular Communication**: Communicate regularly, even with incomplete information